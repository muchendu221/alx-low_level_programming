...
/**
 * _close - close a file descriptor and print an error of failure
...
/**
 *_write - write to a file and print error in failure
 * @filename: name of file to write to
 * @fd: the fiel descriptor to write to
